...
const SignInScreen = ({navigation}) => {
    ...
    function pfnum(){
        ...
        axios.post(Ip+'/user/login',e)
            .then(response =>{
                console.log(Ip)
                global.dm=response.data
                if(dm.message=='Invalid'){
                    Alert.alert('User Approval!', 'Sorry, Your Registration is not Approved Yet. Please try again later.', [
                                    {text: 'Okay'}
                                ]);
                }
                else{
            ...
            .catch(error =>
                {
                    Alert.alert('Sign in!', 'Please check Your PFNumber and Password', [
                        {text: 'Okay'}
                    ]);
                    console.log(error)
                })
    ...
    return (
      ...
      <View style={styles.container}>
           <ScrollView>
          <ImageBackground 
        source={require('../assets/trainhd3.jpg')} 
        ...
        <View style={styles.header}>
            ...
            <TouchableOpacity
             onPress={() => navigation.navigate('EditUserRole')}
            >
